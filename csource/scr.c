...
int ynq(void)
{
  int p='*'; /* the user's choice; start with something impossible
              * to prevent a loop. */
  while ((p != 'n') && (p != 'y') && (p != 'q') && (p != 'k') && (p != 'e')  && (p != ESCAPE) &&
         (p != EOF) && (p != ' '))
    p = wgetch(Msgw);
  switch (p) {
  case 'y': wprintw(Msgw,"yes. "); break;
  case 'n': wprintw(Msgw,"no. "); break;
  case 'k': wprintw(Msgw,"kyllä. "); break;
  case 'e': wprintw(Msgw,"ei. "); break;
...
int ynq2(void)
{
  int p='*'; /* the user's choice; start with something impossible
              * to prevent a loop. */
  while ((p != 'n') && (p != 'y') && (p != 'k') && (p !='e') && (p != 'q') && (p != ESCAPE) &&
         (p != ' ') && (p != EOF))
    p = wgetch(Msg2w);
  switch (p) {
  case 'y': wprintw(Msg2w,"yes. "); break;
  case 'n': wprintw(Msg2w,"no. "); break;
  case 'k': wprintw(Msg2w,"kyllä. "); break;
  case 'e' : wprintw(Msg2w,"ei. "); break;
